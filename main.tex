...
\usepackage{float}% Add in your preamble
% ------------------------------
% ALGORITHMES
% ------------------------------
\usepackage[linesnumbered, ruled, vlined]{algorithm2e}% Images
\usepackage{url}              % URLs dans les références
\usepackage[colorlinks=black,linkcolor=blue,citecolor=black,urlcolor=black]{hyperref}



% --- Bibliographie ---
% Elsevier recommande natbib
\bibliographystyle{elsarticle-harv} % ou elsarticle-harv pour l'auteur-date
...
\author[label2]{Pouya Ataei\corref{cor1}}
\author[label3,label4]{Marcellin Atemkeng\corref{cor1}}
\author[label1]{Emmanuel Fouotsa}

% === CORRESPONDING AUTHORS ===
\cortext[cor1]{Corresponding author: Pouya Ataei  (email: pouya.ataei.7@gmail.com ); Marcellin Atemkeng (email: m.atemkeng@ru.ac.za)}


% === AFFILIATIONS ===
\affiliation[label1]{organization={Center For Cybersecurity and Mathematical Cryptology}, % Département 1
            addressline={},
            city={Bamenda},
            country={Cameroun}}

\affiliation[label2]{organization={Scholarspark.ai},
            addressline={68A, Hendon Avenue, Mount Albert},
            city={Auckland},
            country={New Zealand}}

\affiliation[label3]{organization={Department of Mathematics},
            addressline={Rhodes University, PO Box 94},
            city={Grahamstown 6140},
            country={South Africa}}
\affiliation[label4]{organization={National Institute for Theoretical and Computational Sciences (NITheCS)},
            %addressline={},
            city={Stellenbosch 7600},
            country={South Africa}}
...
$(183,630 × 85)$, $(84,526 × 85)$, $(91,279 × 85)$, $(38,895 × 85)$, $(505,720 × 85)$, $(932,513 × 85)$, and $(710,231 × 85)$.  
...
\bibliography{references}
 % fichier biblio.bib que tu crées à part
