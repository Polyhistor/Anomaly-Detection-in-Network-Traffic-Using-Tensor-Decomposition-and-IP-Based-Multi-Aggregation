...
%test
%\makeatletter
%\IEEEtablecaptionstyle{\color{blue}}
%\makeatother
%test
...
\title{Anomaly Detection in Network Traffic Using Tensor Decomposition and IP-Based Multi-Aggregation}
\author{\uppercase{a}\authorrefmark{1}, \uppercase{b}\authorrefmark{1}, \uppercase{c}\authorrefmark{1} and \uppercase{d}\authorrefmark{1}
\address[1]{
Universities, Email: \texttt{mails}}
}

\markboth
{author \headeretal: Anomaly Detection Using Tensor Decomposition}
{author \headeretal: Anomaly Detection Using Tensor Decomposition}

\corresp{Corresponding author: author (e-mail: author).}
...
\begin{keywords}
Tensor Decomposition, Multi-Aggregation, Deep Learning, Anomaly Detection, Network Security
\end{keywords}
...
\begin{figure*}
    \centering   \includegraphics[width=\linewidth]{Framework_Overview.png}
...
\begin{figure}[!t]
    \centering
\includegraphics[width=0.7\linewidth]{neuro network.png}
...
\begin{figure*}[!t]
    \centering
    \includegraphics[width=0.8\textwidth]{Compression Graph.png}
...
\begin{figure*}[!t]
    \centering    \includegraphics[width=\textwidth]{Source IP mode.png}
...
\begin{figure*}[!t]
    \centering
    \includegraphics[width=\textwidth]{Destination IP mode.png}
...
\begin{figure*}[!t]
    \centering
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{rank_1.png} &
        \includegraphics[width=0.3\textwidth]{rank_2.png} &
        \includegraphics[width=0.3\textwidth]{rank_3.png} \\
...
\begin{figure*}[!t]
    \centering
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{rank_4.png} &
        \includegraphics[width=0.3\textwidth]{rank_5.png} &
        \includegraphics[width=0.3\textwidth]{rank_6.png} \\
        \small Rank 4 & \small Rank 5 & \small Rank 6 \\[3pt]

        \includegraphics[width=0.3\textwidth]{rank_7.png} &
        \includegraphics[width=0.3\textwidth]{rank_8.png} &
        \includegraphics[width=0.3\textwidth]{rank_9.png} \\
        \small Rank 7 & \small Rank 8 & \small Rank 9 \\[3pt]

        \includegraphics[width=0.3\textwidth]{rank_10.png} &
        \includegraphics[width=0.3\textwidth]{rank_11.png} &
        \includegraphics[width=0.3\textwidth]{rank_12.png} \\
...
\begin{figure*}[!t]
    \centering
    \begin{tabular}{ccc}
        \includegraphics[width=0.3\textwidth]{rank_13.png} &
        \includegraphics[width=0.3\textwidth]{rank_14.png} &
        \includegraphics[width=0.3\textwidth]{rank_15.png} \\
        \small Rank 13 & \small Rank 14 & \small Rank 15 \\[6pt]

        \includegraphics[width=0.3\textwidth]{rank_16.png} & & \\
        \small Rank 16 & & 
    \end{tabular}
...
\begin{figure*}[!t]
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.45\textwidth]{Decision tree.png} &
        \includegraphics[width=0.45\textwidth]{Random Forest.png} \\
...
\begin{figure*}[!t]
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.45\textwidth]{support vector Machine.png} &
...
\begin{figure*}[!t]
    \centering
    \includegraphics[width=\textwidth]{compa3.png}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pictures/author.jpg}}]{author}  text.    
\end{IEEEbiography}



\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pictures/author.png}}]{author}
text.  
\end{IEEEbiography}


\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip, keepaspectratio]{pictures/author.jpg}}]{author}
text.      
\end{IEEEbiography}
